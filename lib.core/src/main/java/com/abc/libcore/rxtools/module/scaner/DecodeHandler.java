package com.abc.libcore.rxtools.module.scaner;
...
import com.abc.libcore.rxtools.activity.ActivityScanerCode;
	...
	/*private void decode(byte[] data, int width, int height) {
		...
		if (result != null) {
			if(null != activity.getHandler()){
				...
				msg.obj = "二维码:"+result;
				msg.what = com.abc.base.rxtools.R.id.decode_succeeded;
			...
			if(result_line != null){
				...
				if (null != activity.getHandler()) {
					activity.getHandler().sendEmptyMessage(com.abc.base.rxtools.R.id.decode_failed);
				}
			}
